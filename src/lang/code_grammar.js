...
var grammar = {
    ...
    {"name": "Cond", "symbols": ["Cond", (clexer.has("kw_or") ? {type: "kw_or"} : kw_or), "CondAnd"], "postprocess": ([l, op, r]) => new codeAst.OrCondAst(l, r, op.line, op.col)},
    {"name": "Cond", "symbols": ["CondAnd"], "postprocess": ([p]) => p},
    {"name": "CondAnd", "symbols": ["CondAnd", (clexer.has("kw_and") ? {type: "kw_and"} : kw_and), "CondNot"], "postprocess": ([l, op, r]) => new codeAst.AndCondAst(l, r, op.line, op.col)},
    {"name": "CondAnd", "symbols": ["CondNot"], "postprocess": ([p]) => p},
    {"name": "CondNot", "symbols": [(clexer.has("kw_not") ? {type: "kw_not"} : kw_not), "CondNot"], "postprocess": ([op, p]) => new codeAst.NotCondAst(p, op.line, op.col)},
    {"name": "CondNot", "symbols": [(clexer.has("lparen") ? {type: "lparen"} : lparen), "Cond", (clexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([_lp, p, _rp]) => p},
    {"name": "CondNot", "symbols": ["AtomicCond"], "postprocess": ([p]) => p},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("equalequal") ? {type: "equalequal"} : equalequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '==', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("notequal") ? {type: "notequal"} : notequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '!=', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("lessequal") ? {type: "lessequal"} : lessequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '<=', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("greaterequal") ? {type: "greaterequal"} : greaterequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '>=', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("lessthan") ? {type: "lessthan"} : lessthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '<', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": ["Expr", (clexer.has("greaterthan") ? {type: "greaterthan"} : greaterthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '>', r, op.line, op.col)},
    {"name": "AtomicCond", "symbols": [(clexer.has("kw_true") ? {type: "kw_true"} : kw_true)], "postprocess": ([tok]) => new codeAst.TrueCondAst(tok.line, tok.col)},
    {"name": "AtomicCond", "symbols": [(clexer.has("kw_false") ? {type: "kw_false"} : kw_false)], "postprocess": ([tok]) => new codeAst.FalseCondAst(tok.line, tok.col)},
