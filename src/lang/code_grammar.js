...
var grammar = {
    ...
    {"name": "RequiresClause", "symbols": [(clexer.has("kw_requires") ? {type: "kw_requires"} : kw_requires), "PropList"], "postprocess": ([_kw, cs]) => cs},
    {"name": "EnsuresClause", "symbols": [], "postprocess": () => []},
    {"name": "EnsuresClause", "symbols": [(clexer.has("kw_ensures") ? {type: "kw_ensures"} : kw_ensures), "PropList"], "postprocess": ([_kw, cs]) => cs},
    {"name": "PropList", "symbols": ["Prop"], "postprocess": ([c]) => [c]},
    {"name": "PropList", "symbols": ["PropList", (clexer.has("comma") ? {type: "comma"} : comma), "Prop"], "postprocess": ([cs, _c, c]) => [...cs, c]},
    ...
    {"name": "Prop", "symbols": ["Prop", (clexer.has("kw_or") ? {type: "kw_or"} : kw_or), "PropAnd"], "postprocess": ([l, op, r]) => new codeAst.OrCondAst(l, r, op.line, op.col)},
    {"name": "Prop", "symbols": ["PropAnd"], "postprocess": ([p]) => p},
    {"name": "PropAnd", "symbols": ["PropAnd", (clexer.has("kw_and") ? {type: "kw_and"} : kw_and), "PropNot"], "postprocess": ([l, op, r]) => new codeAst.AndCondAst(l, r, op.line, op.col)},
    {"name": "PropAnd", "symbols": ["PropNot"], "postprocess": ([p]) => p},
    {"name": "PropNot", "symbols": [(clexer.has("kw_not") ? {type: "kw_not"} : kw_not), "PropNot"], "postprocess": ([op, p]) => new codeAst.NotCondAst(p, op.line, op.col)},
    {"name": "PropNot", "symbols": [(clexer.has("lparen") ? {type: "lparen"} : lparen), "Prop", (clexer.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([_lp, p, _rp]) => p},
    {"name": "PropNot", "symbols": ["AtomicProp"], "postprocess": ([p]) => p},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("equalequal") ? {type: "equalequal"} : equalequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '==', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("notequal") ? {type: "notequal"} : notequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '!=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("lessequal") ? {type: "lessequal"} : lessequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '<=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("greaterequal") ? {type: "greaterequal"} : greaterequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '>=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("lessthan") ? {type: "lessthan"} : lessthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '<', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("greaterthan") ? {type: "greaterthan"} : greaterthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.RelAst(l, '>', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": [(clexer.has("kw_true") ? {type: "kw_true"} : kw_true)], "postprocess": ([tok]) => new codeAst.TrueCondAst(tok.line, tok.col)},
    {"name": "AtomicProp", "symbols": [(clexer.has("kw_false") ? {type: "kw_false"} : kw_false)], "postprocess": ([tok]) => new codeAst.FalseCondAst(tok.line, tok.col)},
