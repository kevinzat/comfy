...
var grammar = {
    ...
    {"name": "Prop", "symbols": ["Prop", (clexer.has("kw_or") ? {type: "kw_or"} : kw_or), "PropAnd"], "postprocess": ([l, op, r]) => new codeAst.OrPropAst(l, r, op.line, op.col)},
    {"name": "Prop", "symbols": ["PropAnd"], "postprocess": ([p]) => p},
    {"name": "PropAnd", "symbols": ["PropAnd", (clexer.has("kw_and") ? {type: "kw_and"} : kw_and), "PropNot"], "postprocess": ([l, op, r]) => new codeAst.AndPropAst(l, r, op.line, op.col)},
    {"name": "PropAnd", "symbols": ["PropNot"], "postprocess": ([p]) => p},
    {"name": "PropNot", "symbols": [(clexer.has("kw_not") ? {type: "kw_not"} : kw_not), "PropNot"], "postprocess": ([op, p]) => new codeAst.NotPropAst(p, op.line, op.col)},
    ...
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("equalequal") ? {type: "equalequal"} : equalequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '==', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("notequal") ? {type: "notequal"} : notequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '!=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("lessequal") ? {type: "lessequal"} : lessequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '<=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("greaterequal") ? {type: "greaterequal"} : greaterequal), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '>=', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("lessthan") ? {type: "lessthan"} : lessthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '<', r, op.line, op.col)},
    {"name": "AtomicProp", "symbols": ["Expr", (clexer.has("greaterthan") ? {type: "greaterthan"} : greaterthan), "Expr"], "postprocess": ([l, op, r]) => new codeAst.CondAst(l, '>', r, op.line, op.col)},
