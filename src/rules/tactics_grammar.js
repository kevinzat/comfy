...
var grammar = {
    ...
    {"name": "Tactic", "symbols": [(lexer2.has("defof") ? {type: "defof"} : defof), (lexer2.has("variable") ? {type: "variable"} : variable), "Refs"], "postprocess": ([a, name, refs]) => new ast.DefinitionTacticAst(name.text, true, refs)},
    {"name": "Tactic", "symbols": [(lexer2.has("defof") ? {type: "defof"} : defof), (lexer2.has("variable") ? {type: "variable"} : variable), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Expr", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, name, _lp, e, _rp]) => new ast.DefinitionTacticAst(name.text, true, [], e)},
    {"name": "Tactic", "symbols": [(lexer2.has("defof") ? {type: "defof"} : defof), (lexer2.has("variable") ? {type: "variable"} : variable), "Refs", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Expr", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, name, refs, _lp, e, _rp]) => new ast.DefinitionTacticAst(name.text, true, refs, e)},
    ...
    {"name": "Tactic", "symbols": [(lexer2.has("undef") ? {type: "undef"} : undef), (lexer2.has("variable") ? {type: "variable"} : variable), "Refs"], "postprocess": ([a, name, refs]) => new ast.DefinitionTacticAst(name.text, false, refs)},
    {"name": "Tactic", "symbols": [(lexer2.has("undef") ? {type: "undef"} : undef), (lexer2.has("variable") ? {type: "variable"} : variable), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Expr", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, name, _lp, e, _rp]) => new ast.DefinitionTacticAst(name.text, false, [], e)},
    {"name": "Tactic", "symbols": [(lexer2.has("undef") ? {type: "undef"} : undef), (lexer2.has("variable") ? {type: "variable"} : variable), "Refs", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Expr", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, name, refs, _lp, e, _rp]) => new ast.DefinitionTacticAst(name.text, false, refs, e)},
